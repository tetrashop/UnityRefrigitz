...
//#pragma warning restore CS0414 // The field 'ThingsConverter.Spaces' is assigned but its value is never used
        ...
        //Constructor
        public ThingsConverter(bool Arrangments, int i, int j, int a, int[,] Tab, int Ord, bool TB, int Cur//,ref AllDraw. THI
            )
        {
            //long Time = TimeElapced.TimeNow();Spaces++;
        ...
        public ThingsConverter(bool arrangmentsChanged, int rowSource, int columnSource, int color, int[,] tableS, int order, int v)
        {
            //long Time = TimeElapced.TimeNow();Spaces++;
